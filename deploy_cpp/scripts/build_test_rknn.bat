...
adb push --sync ./tmp_files/test2.mp4 /data/local/tmp/
...
adb shell "export LD_LIBRARY_PATH=/data/local/tmp:$LD_LIBRARY_PATH && /data/local/tmp/test_excavator /data/local/tmp/best_320.rknn /data/local/tmp/test2.mp4 4 /data/local/tmp/out_low_fps/low_fps_%%04d.jpg"
